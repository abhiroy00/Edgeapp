...
export default function LeftSidebar() {
  ...
  return (
    <div className="left-side-bar-main h-screen w-[300px] text-black flex flex-col" style={{backgroundColor:"#d8eefc"}}>
      {/* Logo Section */}
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        {/* Configuration */}
        <div className="configuration p-3 rounded-lg hover:bg-fuchsia-900 cursor-pointer transition duration-200 flex items-center">
          <svg className="w-5 h-5 mr-3 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
